...
| `anleitungen/` | `Kammertest_MB7574.md`, `Netzteiltest_EX355P.md` |
...
| `programm` | Messprogramm: `./programm 20 -40 -70 20` (Kammer fahren, stabil warten, Stufe mit Netzteil messen, nächste Temperatur) |
| `skripte/` | `mb7574_kammerlog.py` (Logger), `klimakammer.py` (Kammer), `ex355p.py` (Netzteil EX355P), `messprogramm.py` |
| `tests/` | `test_kammerlog.py`, `test_klimakammer.py`, `test_messprogramm.py`, ohne Hardware |
