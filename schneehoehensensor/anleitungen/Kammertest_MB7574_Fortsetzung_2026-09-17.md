...
1. Netzteil ein, Multimeter Ader 7 (weiß) gegen Ader 4 (schwarz). Etwa 1 mV je mm Abstand: Der Sensor misst, nur die serielle Ausgabe fällt aus.
2. Nach 15 min die Stufe wiederholen, Beispiel für −60 °C:

```
python3 schneehoehensensor/skripte/mb7574_kammerlog.py stufe -60 --tag wdh
```

3. Bleibt er aus: nicht weiter abkühlen, sondern 10 K wärmer, 30 min halten, Stufe messen.
...
In `notizen.md` eintragen und speichern: Laborbuchseiten; Kennung `MB7574-01`, keine Seriennummer vorhanden; gemessener Abstand; Abweichung „Montag −20 °C ohne vorherige +20-°C-Stufe“; Ergebnis in einem Satz.
