...
- **Automatischer Push:** `./kammer neu` und jede `./kammer stufe` checken den Laufordner selbst ein und pushen ihn, nur den Laufordner, nie Code. Klappt der Push nicht (kein Netz), läuft alles weiter; die nächste Stufe pusht erneut. Abschalten mit `--kein-push`.
