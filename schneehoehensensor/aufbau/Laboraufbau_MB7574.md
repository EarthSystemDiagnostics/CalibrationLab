...
![Buchse mit Kabel. Im Bild von links: Pin 2 frei, Pin 3 weiß, Pin 4 grau, Pin 5 blau, Pin 6 rot + braun, Pin 7 gelbgrün + schwarz.](fotos/2026-09-14_Buchse_Kabel.jpg){width=6cm}
...
5. Erstes Einschalten auf dem Tisch: 5,00 V, Strombegrenzung 150 mA, im Lauf des Tages `stufe 20 --tag tisch`. Erwartet: Kopfzeile, Werte „Rxxxx", Strom um 68 mA.

## Rechner

- Logger: `schneehoehensensor/skripte/mb7574_kammerlog.py` (Python 3, pyserial), Aufruf im Repo-Ordner. Findet den FTDI-Port `/dev/cu.usbserial-*` selbst. Ablauf: `../anleitungen/Kammertest_MB7574.md`.
